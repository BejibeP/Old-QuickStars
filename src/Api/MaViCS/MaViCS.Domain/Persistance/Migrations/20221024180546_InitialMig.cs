    ...
    public partial class InitialMig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "Application", new DateTime(2022, 10, 24, 18, 5, 46, 316, DateTimeKind.Utc).AddTicks(5077), null, null, "A Sunken city", 0m, 0m, null, null, "Atlantis", "Ocean" });

            migrationBuilder.InsertData(
                table: "Talents",
                columns: new[] { "Id", "CreatedBy", "CreatedOn", "DeletedBy", "DeletedOn", "HomeTownId", "ModifiedBy", "ModifiedOn", "Name", "Surname", "Title" },
                values: new object[] { 1L, "Application", new DateTime(2022, 10, 24, 18, 5, 46, 316, DateTimeKind.Utc).AddTicks(5208), null, null, 1L, null, null, "Gura", "Gawr", "Shark-Girl Idol" });

            migrationBuilder.InsertData(
                table: "Tours",
                columns: new[] { "Id", "CreatedBy", "CreatedOn", "DeletedBy", "DeletedOn", "Description", "ModifiedBy", "ModifiedOn", "Name", "StartedOn", "TalentId" },
                values: new object[] { 1L, "Application", new DateTime(2022, 10, 24, 18, 5, 46, 316, DateTimeKind.Utc).AddTicks(5225), null, null, null, null, null, "Shark First Concert", new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1L });

            migrationBuilder.InsertData(
                table: "Shows",
                columns: new[] { "Id", "CreatedBy", "CreatedOn", "Date", "DeletedBy", "DeletedOn", "LocationId", "ModifiedBy", "ModifiedOn", "TourId" },
                values: new object[] { 1L, "Application", new DateTime(2022, 10, 24, 18, 5, 46, 316, DateTimeKind.Utc).AddTicks(5240), new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, 1L, null, null, 1L });
